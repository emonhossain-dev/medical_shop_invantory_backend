...
#     roles: Mapped[list["Role"]] = relationship(back_populates="store", cascade="all, delete-orphan")
...
#     __tablename__ = "roles"
#     __table_args__ = (
#         UniqueConstraint("store_id", "name", name="uq_store_role_name"),
#     )
#
#     id: Mapped[int] = mapped_column(Integer, primary_key=True)
#     store_id: Mapped[int] = mapped_column(ForeignKey("stores.id", ondelete="CASCADE"), nullable=False, index=True)
#     name: Mapped[str] = mapped_column(String(100), nullable=False)
#     is_system_default: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)  # "Owner" role, non-deletable
#     is_active: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
#     created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, server_default="now()")
#
#     store: Mapped["Store"] = relationship(back_populates="roles")
#     permissions: Mapped[list["RolePermission"]] = relationship(back_populates="role", cascade="all, delete-orphan")
#     members: Mapped[list["StoreMember"]] = relationship(back_populates="role")
#
#
...
#         SAEnum(ModuleName, name="module_name", create_type=False), nullable=False
#     )
...
#         index=True
#     )
#     start_date: Mapped[date] = mapped_column(Date, nullable=False, server_default="CURRENT_DATE")
